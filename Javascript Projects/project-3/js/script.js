...
let chineBtn = document.getElementById("China");
...
function addButton() {
  container.innerHTML =
    ...
    " " +
    createButton("China");
  allBtn.addEventListener("click", addFoodsAll);
  koreaBtn.addEventListener("click", addFoodsKorea);
  japanBtn.addEventListener("click", addFoodsJapan);
  chineBtn.addEventListener("click", addFoodsChina);
}
